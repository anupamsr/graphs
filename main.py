...
def main():
    ...
    print_info(g5)
    petersen = GraphAL()
    petersen.add_edges(1, [3, 4, 6], [1, 1, 2])
    petersen.add_edges(2, [4, 5, 7], [1, 1, 2])
    petersen.add_edges(3, [5, 1, 8], [1, 1, 2])
    petersen.add_edges(4, [1, 2, 9], [1, 1, 2])
    petersen.add_edges(5, [2, 3, 10], [1, 1, 2])
    petersen.add_edges(6, [1, 7, 10], [2, 3, 3])
    petersen.add_edges(7, [2, 6, 8], [2, 3, 3])
    petersen.add_edges(8, [3, 7, 9], [2, 3, 3])
    petersen.add_edges(9, [4, 8, 10], [2, 3, 3])
    petersen.add_edges(10, [5, 9, 6], [2, 3, 3])
    print_info(petersen)
